    ...
    >
      ...
      <div className="mt-4 pt-3 border-t border-[#DCE4DE]/60 flex items-center justify-between">
        <div className="flex flex-col">
          <span className="text-[11px] text-[#66706B] font-medium uppercase tracking-wider">
            Precio estimado
          </span>
          <span className="text-[15px] font-extrabold text-[#0FA37F]">
            {t("price_from", { price: provider.priceFromArs.toLocaleString("es-AR") })}
          </span>
        </div>
