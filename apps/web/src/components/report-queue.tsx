...
type Report = {id: string; reason: string; details: string; status: string; created_at: string; providers?: Array<{slug?: string; profiles?: Array<{display_name?: string}>}>};

export function ReportQueue({initialReports}: {initialReports: Report[]}) {
