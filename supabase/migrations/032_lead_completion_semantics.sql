-- Completion semantics: distinguish "provider says done" from "customer confirms".
-- Flow: provider_service_completed -> customer_completion_confirmed -> success
-- This gives honest outcome analytics instead of letting either party unilaterally
-- mark a lead as success.
