...
-- BEGIN supabase/migrations/019_directory_read_policies.sql
...
-- END supabase/migrations/019_directory_read_policies.sql

-- BEGIN supabase/migrations/020_lead_foundation.sql
...
-- END supabase/migrations/020_lead_foundation.sql

-- BEGIN supabase/migrations/021_lead_event_history.sql
...
-- END supabase/migrations/021_lead_event_history.sql

-- BEGIN supabase/migrations/022_transactional_lead_lifecycle.sql
...
-- END supabase/migrations/022_transactional_lead_lifecycle.sql

-- BEGIN supabase/migrations/023_admin_bot_idempotency.sql
...
-- END supabase/migrations/023_admin_bot_idempotency.sql

-- BEGIN supabase/migrations/024_lead_immutability_and_transition_guard.sql
...
$$;
-- END supabase/migrations/024_lead_immutability_and_transition_guard.sql
